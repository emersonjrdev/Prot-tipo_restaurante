import { demoApiRequest, isDemoBackendEnabled } from './demoBackend'

export { isDemoBackendEnabled as isDemoApiMode } from './demoBackend'

const configuredBase = String(import.meta.env.VITE_API_URL || '').trim()
const fallbackBase =
  import.meta.env.DEV && !isDemoBackendEnabled() ? 'http://localhost:3001' : ''
...
export async function apiRequest(path, { method = 'GET', body, headers } = {}) {
  if (isDemoBackendEnabled()) {
    return demoApiRequest(path, { method, body, headers })
  }
